return {
    ...
    config = function()
        ...
        vim.api.nvim_set_keymap(
            'n',
            '<leader>df',
            ':DiffviewFileHistory --no-merges --max-count=100 %<CR>',
            { desc = 'Git File History (NO MERGES)' }
        )
        vim.api.nvim_set_keymap(
            'n',
            '<leader>dr',
            ':DiffviewFileHistory --max-count=100 %<CR>',
            { desc = 'Git File History' }
        )
        vim.api.nvim_set_keymap(
            'n',
            '<leader>dd',
            ':DiffviewFileHistory --no-merges --max-count=1000<CR>',
        ...
        vim.api.nvim_set_keymap(
            'n',
            '<leader>ds',
            ':DiffviewFileHistory -g --range=stash<CR>',
        ...
        vim.api.nvim_set_keymap(
            'n',
            '<leader>da',
            ':DiffviewFileHistoryByAuthor<CR>',
        ...
        vim.api.nvim_set_keymap(
            'n',
            '<leader>dm',
            ':DiffviewFileHistoryByMessage<CR>',
        ...
        vim.api.nvim_set_keymap('n', '<leader>dS', ':DiffviewFileHistoryBySHA<CR>', { desc = 'View commit by SHA' })
    end,
}
